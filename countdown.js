...
var MARGIN_LEFT = 30;		//第一个数字距离画布左边距
const endTime = new Date(2016,11,5,18,47,52);//月份是从0-11，表示1-12月
...
function render(cxt) {
	cxt.clearRect(0, 0, WINDOW_WIDTH, WINDOW_HEIGHT);//对矩形区域进行刷新操作,逐帧动画
